...
const bookingStatus = lazy(()=>
  import("./views/pages/Booking/BookingStatus")
)
const dev = lazy(()=>
  import("./views/pages/Developers/Developers")
)
const buyermaster = lazy(()=>
  import("./views/BuyerMaster/BuyerMaster")
)
  ...
  render() {
    return (
      ...
      <Router history={history}>
        <Switch>
          <AppRoute exact path="/" component={projects} />
          ...
          <AppRoute exact path="/booking-status/view" component={bookingStatus} />
          <AppRoute exact path="/sale/sale-inventory" component={SaleInventorymaster} />
